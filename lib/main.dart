...
import 'package:sito/preview_page.dart';
import 'eventi_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/studio': (context) =>
            PreviewPage(imagePath: 'assets/studio/foto1.jpg'),
        '/eventi': (context) => EventiPage(),
        '/contatti': (context) => ContattiPage()
      },
    );
  }
}
